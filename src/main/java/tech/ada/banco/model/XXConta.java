...
public class XXConta {
    ...
    private XXModalidadeConta tipo;
    ...
    private XXPessoa titular;

    public XXConta(XXModalidadeConta tipo, XXPessoa titular) {
        this();
        this.tipo = tipo;
    ...
    public XXModalidadeConta getTipo() {
        return tipo;
    }
