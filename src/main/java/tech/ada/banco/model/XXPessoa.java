...
@Entity
@Table(name = "EPESSOA")
public class XXPessoa {

    @Id
    @SequenceGenerator(name = "pessoaSequenceGenerator", sequenceName = "BPESSOA_SQ", initialValue = 100)
    ...
    public XXPessoa(String nome, String cpf, LocalDate dataNascimento) {
